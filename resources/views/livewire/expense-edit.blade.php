<div class="container mx-auto p-4 dark:bg-gray-800 dark:text-gray-200">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-fuchsia-500 to-rose-500">Edit Pengeluaran</h2>
    </div>

    <div class="max-w-3xl mx-auto">
        <form wire:submit="save">
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-8 border border-gray-200 dark:border-gray-700">
                <div class="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-2 mb-6">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Formulir Edit</h3>
                    <div class="text-sm text-gray-500">ID: {{ $expense->id }}</div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" step="0.01" id="amount" wire:model="amount" class="block w-full rounded-lg border-gray-300 pl-10 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white transition ease-in-out duration-150">
                        </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" wire:model="description" rows="4" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white transition ease-in-out duration-150"></textarea>
                        @error('description') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                    </div>
                </div>

                <div class="mt-8 flex justify-between items-center">
                    <button type="button" wire:click="delete" wire:confirm="Yakin ingin menghapus data pengeluaran ini?" class="inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-150 ease-in-out">
                         Hapus Data
                    </button>
