        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('products.print-list') }}" 
                       target="_blank"
                       class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-black rounded-xl transition-all shadow-lg active:scale-95 gap-2 text-base">
                    ...
                    <div class="flex-1 w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full pl-11 pr-4 py-2.5 rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-emerald-500 focus:border-emerald-500 text-sm font-medium shadow-sm"
                            ...
                            @foreach($product->productUnits as $unit)
                                <div class="bg-gray-50 dark:bg-gray-900/50 p-3 rounded-xl border border-gray-100 dark:border-gray-700 flex justify-between items-center shadow-sm">
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        @if($unit->member_price)
                                        <div class="flex flex-col items-end border-l border-gray-200 dark:border-gray-700 pl-3">
                                            <span class="text-[9px] text-indigo-500 font-black uppercase tracking-tighter">Member</span>
                                            <span class="text-base font-black text-indigo-600 dark:text-indigo-400">{{ number_format($unit->member_price, 0, ',', '.') }}</span>
                                        </div>
                                        @endif
                                    </div>
                                </div>
